     ...
     <body>
          ...
          <nav class="navbar navbar-expand-xl ">
               ...
               <div class=" flex-row-reverse right ">
                    ...
                    <div class="dropdown p-2 settings ">
                         <button class="btn  dropdown-toggle text-success" style="margin-top:-20px;" type="button"
          ...
          <div class="row" style="text-align:center;">
               <div class="col-md-3 col-sm-12">
                    <a href="farmerHomepage.php" id="navbar"><i class="fa fa-home"
                              aria-hidden="true"></i><label>Home</label></a>
               </div>
               <div class="col-md-3 col-sm-12">
                    <a href="MyProducts.php" id="navbar"><i class="fa fa-leaf" aria-hidden="true"></i><label>My
                              Products</label></a>
               </div>
               <div class="col-md-3 col-sm-12">
                    <a href="Transactions.php" id="navbar"><i class="fa fa-exchange" aria-hidden="true"></i><label>My
                              Transactions</label></a>
               </div>
               <div class="col-md-3 col-sm-12">
                    <a href="CallCenter.php" id="navbar"><i class="fa fa-phone fa-rotate-vertical"
                              aria-hidden="true"></i><label>Call Centers/SMS</label></a>
               </div>
          </div>
          <hr>
          ...
          <div style="display:block;">
               ...
               <div class=content_item><label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>TRANSACTION
                              HISTORY</b></label></div>
               <br>
          </div>
                         ...
                         if (isset($_SESSION['phonenumber'])) {
                              ...
                              while ($p_price = mysqli_fetch_array($run_price)) {
                                   ...
                                   while ($pp_price = mysqli_fetch_array($run_pro_price)) {
                                        ...
                                        // Query to get buyer name
                                        $query_name = "select * from buyerregistration where buyer_phone = '$phone'";
                                        $run_query_name = mysqli_query($con, $query_name);

                                        // Error handling for buyer query
                                        if (!$run_query_name) {
                                             echo "Error fetching buyer name: " . mysqli_error($con);
                                             continue;
                                        }

                                        // Display product and buyer info
                                        while ($names = mysqli_fetch_array($run_query_name)) {
                                             ...
                                             <tr>
                                                  ...
                                                  <td data-label="Name">
                                                       <?php echo isset($buyer_name) ? $buyer_name : "Buyer Info Not Available"; ?></td>
               ...
               <div class="container">
                    ...
                    <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                              <p><u><a href="https://www.agrocraft.com/">AgroCraft Corporation</a></u> is a Multitrading
                                   Company for farmers ang traders</p>
                              <p class="h6">Copy All right Reversed.<a class="text-green ml-2"
                                        href="https://www.google.com" target="_blank">Agrotech</a></p>
                         </div>
                         </hr>
                    </div>
               </div>
